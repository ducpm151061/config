# Generated by Powerlevel10k configuration wizard on 2020-07-31 at 12:10 +07.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 38309.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, sharp heads, blurred tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=91
  # Custom icon.
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=16
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=46
  # Custom icon.
